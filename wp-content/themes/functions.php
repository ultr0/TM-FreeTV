...
class zerif_team_widget extends WP_Widget
{
    ...
    function form($instance)
    {
        ...
        <p>
            ...
            <label
                for="<?php echo $this->get_field_id('bh_link'); ?>"><?php _e('Instagram link', 'zerif-lite'); ?></label><br/>
        ...
        <p>
            ...
            <label
                for="<?php echo $this->get_field_id('db_link'); ?>"><?php _e('Youtube Link', 'zerif-lite'); ?></label><br/>
		...
		<p>
            ...
            <label
                for="<?php echo $this->get_field_id('ln_link'); ?>"><?php _e('Одноклассники', 'zerif-lite'); ?></label><br/>
