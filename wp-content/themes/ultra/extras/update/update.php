...
function siteorigin_theme_update_settings() {
	...
	siteorigin_settings_add_field('premium', 'order_number', 'text', __('Order Number', 'ultra'), array(
		'description' => __('Enter the Ultra Premium order number sent to you via email.', 'ultra')
	));
}
