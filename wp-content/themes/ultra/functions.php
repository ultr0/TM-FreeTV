...
function ultra_scripts() {
	...
	wp_localize_script( 'ultra-responsive-menu', 'resp_menu_params', array(
		'collapse' => siteorigin_setting('navigation_responsive_menu_collapse')
	) );	
}
...
function ultra_set_header_opacity() {
	if ( siteorigin_setting( 'header_opacity' ) == '0.9' ) return;
