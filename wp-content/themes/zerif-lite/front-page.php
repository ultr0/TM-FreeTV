				...
				<div class="row">
					...
					<form role="form" method="POST" action="" onSubmit="this.scrollPosition.value=(document.body.scrollTop || document.documentElement.scrollTop)" class="contact-form">
						...
						<div class="col-lg-4 col-sm-4" data-scrollreveal="enter left after 0s over 1s">
							...
							<input required="required" type="text" name="myname" placeholder="Ваше имя" class="form-control input-box" value="<?php if(isset($_POST['myname'])) echo esc_attr($_POST['myname']);?>">
						...
						<div class="col-lg-4 col-sm-4" data-scrollreveal="enter left after 0s over 1s">
							...
							<input required="required" type="text" name="mysubject" placeholder="Телефон" class="form-control input-box" value="<?php if(isset($_POST['mysubject'])) echo esc_attr($_POST['mysubject']);?>">

						</div>

						<div class="col-lg-12 col-sm-12" data-scrollreveal="enter right after 0s over 1s">

							<textarea name="mymessage" class="form-control textarea-box" placeholder="Ваше сообщение"><?php if(isset($_POST['mymessage'])) { echo esc_html($_POST['mymessage']); } ?></textarea>
